---
name: commit-message
description: "스테이지된 변경을 바탕으로 Gitmoji Commits 형식의 커밋 메시지를 2인 팀(author·reviewer)으로 생성. '커밋 메시지', 'commit message', '커밋 메시지 만들어줘' 같은 자연어 요청 시 반드시 사용. 단, 이미 메시지가 작성된 `git commit -m` 대체는 아니다."
allowed-tools: Bash Read Write
---

# Commit Message Skill
2인 팀을 순차로 호출해 [Gitmoji](https://gitmoji.dev/) Commits 형식의 커밋 메시지를 생성한다.
